...
public class MessageHandlerRequestChat implements IMessageHandlerByteArray {

    private final LocalBroadcastManager mBroadCastManager;

    public MessageHandlerRequestChat(Context context) {
    ...
    public static ConnectionMessage createConnectionMessageFromChatMessage(String chatMessage) {
        return new ConnectionMessage(ConnectionMessage.TYPE_REQUEST_CHAT, chatMessage.getBytes());
    }
}
